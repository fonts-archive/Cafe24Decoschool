...
사용하는 `font-family`의 이름은 `Cafe24 Decoschool`입니다.

### HTML

```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/Cafe24Decoschool/Cafe24Decoschool.css" type="text/css"/>
```

### CSS `@Import`

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/Cafe24Decoschool/Cafe24Decoschool.css');
```
...
```css
@font-face {
    font-family: 'Cafe24 Decoschool';
    font-weight: normal;
    font-style: normal;
    font-display: swap;
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/Cafe24Decoschool/Cafe24Decoschool.woff2') format('woff2'),
         url('https://cdn.jsdelivr.net/gh/fonts-archive/Cafe24Decoschool/Cafe24Decoschool.woff') format('woff'),
         url('https://cdn.jsdelivr.net/gh/fonts-archive/Cafe24Decoschool/Cafe24Decoschool.otf') format('opentype'),
         url('https://cdn.jsdelivr.net/gh/fonts-archive/Cafe24Decoschool/Cafe24Decoschool.ttf') format('truetype');
}
```
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/Cafe24Decoschool/subsets/Cafe24Decoschool-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/Cafe24Decoschool/subsets/Cafe24Decoschool-dynamic-subset.css');
```
...
```css
font-family: "Cafe24 Decoschool", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
...
카페24(주)이 제공하는 "Cafe24 Decoschool"는 SIL OPEN FONT LICENSE(Version 1.1)에 따라 사용이 허가됩니다.

"Cafe24 Decoschool"의 지적 재산권은 카페24(주)에 있습니다.
"Cafe24 Decoschool"은 개인 및 기업 사용자를 포함한 모든 사용자에게 무료로 제공되며 자유롭게 수정하고 재배포할 수 있습니다.
단, 글꼴 자체를 유료로 판매하는 것은 금지하며 본 저작권 안내와 라이선스 전문을 포함해서 다른 소프트웨어와 번들하거나 재배포 또는 판매가 가능합니다.
라이선스 전문을 포함하기 어려울 경우, 출처 표기를 권장합니다.
예) 이 페이지에는 카페24(주)이 제공한 "Cafe24 Decoschool"이 적용되어 있습니다.
"Cafe24 Decoschool"이 사용된 인쇄물, 광고물(온라인 포함)의 이미지는 카페24(주)의 프로모션을 위해 활용될 수 있습니다.
